...
ICONTARGETFILENAME=$(TARGETDIR)\svgtester_0xE65D4A7B.mif
...
$(ICONTARGETFILENAME) : $(ICONDIR)\qgn_menu_svgtester.svg
	mifconv $(ICONTARGETFILENAME) -c32,8 $(ICONDIR)\qgn_menu_svgtester.svg
